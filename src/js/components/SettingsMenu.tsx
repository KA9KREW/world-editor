                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex gap-x-2 items-center w-full opacity-0 duration-150 cursor-pointer fade-down" style={{
                            ...
                            <input
                                ...
                                onBlur={(e) => handleViewDistanceChange(Math.max(32, Math.min(5000, Number(e.target.value))))}
                                onKeyDown={(e: any) => {
                                    e.stopPropagation();
                                    if (e.key === 'Enter') {
                                        handleViewDistanceChange(Math.max(32, Math.min(5000, Number(e.target.value))));
                                        e.target.blur();
                                    }
                                }}
                                min={32}
                            ...
                            <input
                                ...
                                style={{
                                    ...
                                    background: `linear-gradient(to right, rgba(255, 255, 255, 0.5) 0%, rgba(255, 255, 255, 0.8) ${(viewDistance - 32) / (5000 - 32) * 100}%, rgba(255, 255, 255, 0.1) ${(viewDistance - 32) / (5000 - 32) * 100}%, rgba(255, 255, 255, 0.1) 100%)`
                                }}
                            />
